                ...
                <div className="quiz__container cover-type__options">
                        ...
                        <div className="cover-type__micro-options quiz__cards">
                            <label className="cover-type__micro-option quiz__card">
                                <div className="quiz__card-body">
                                    <img src="img/quiz/soft_kleevoy.png" alt="" title=""/>
                                </div>
                            ...
                            <label className="cover-type__micro-option quiz__card">
                                <div className="quiz__card-body">
                                    <img src="img/quiz/soft_proshitiy.png" alt="" title=""/>
                                </div>
                                <footer className="quiz__card-footer">
                                    <p> КШС <br/>(прошитый)</p>
                            ...
                            <label className="cover-type__micro-option quiz__card">
                                <div className="quiz__card-body">   
                                    <img src="img/quiz/soft_skoba.png" alt="" title=""/>
                                </div>
                                <footer className="quiz__card-footer">
                                    <p> Скобка </p>
                            ...
                            <label className="cover-type__micro-option quiz__card">
                                <div className="quiz__card-body">
                                    <img src="img/quiz/soft_pruzhina.png" alt="" title=""/>
                                </div>
                                <footer className="quiz__card-footer">
                                    <p> Пружина </p>
                    ...
                    <fieldset className="cover-type__macro-option">
                        ...
                        <div className="cover-type__micro-options quiz__cards">
                            <label className="cover-type__micro-option quiz__card">
                                <div className="quiz__card-body">
                                    <img src="img/quiz/hard_colorful.png" alt="" title=""/>
                                </div>
                                <footer className="quiz__card-footer">
                                    <p> 7БЦ <br/>(цветной)</p>
                            ...
                            <label className="cover-type__micro-option quiz__card">
                                <div className="quiz__card-body">
                                    <img src="img/quiz/hard_leisure.png" alt="" title=""/>
                                </div>
                                <footer className="quiz__card-footer">
                                    <p> 7Б <br/>(под кожу)</p>
                            ...
                            <label className="cover-type__micro-option quiz__card">
                                <div className="quiz__card-body">   
                                    <img src="img/quiz/hard_integralny.png" alt="" title=""/>
                                </div>
                                <footer className="quiz__card-footer">
                                    <p> Интегральный </p>
